...
const Footer = () => {
	return (
		<div className="flex p-10 sm:p-10 sm:flex justify-between gap-[5%] sm:justify-between  items-center sm:items-center bg-black/25 mt-[5%] sm:mt-[15%] self-center sm:self-auto">
